...
public class MealServiceTest {
    ...
    public void create() throws Exception {
        ...
        newMeal.setId(newId);
        MEAL_MATCHER_WO_USER.assertMatch(created, newMeal);
        MEAL_MATCHER_WO_USER.assertMatch(service.get(newId, USER_ID), newMeal);
    }
    ...
    public void getAll() throws Exception {
        MEAL_MATCHER_WO_USER.assertMatch(service.getAll(USER_ID), MEALS);
    }

    @Test
    public void getBetweenInclusive() throws Exception {
        MEAL_MATCHER_WO_USER.assertMatch(service.getBetweenInclusive(
    ...
    public void getBetweenWithNullDates() throws Exception {
        MEAL_MATCHER_WO_USER.assertMatch(service.getBetweenInclusive(null, null, USER_ID), MEALS);
    }
}